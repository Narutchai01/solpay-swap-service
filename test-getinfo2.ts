...
async function main() {
  ...
  const { poolInfo, tickData } = await raydium.clmm.getPoolInfoFromRpc("FXAXqgjNK6JVzVV2frumKTEuxC8hTEUhVTJTRhMMwLmM");
  ...
  const quote = PoolUtils.computeAmountOutFormat({
    poolInfo: clmmPoolInfo as any, // Try clmmPoolInfo
    tickArrayCache: tickCache as any, // Try tickCache
